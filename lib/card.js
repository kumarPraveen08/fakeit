...
- A mastercard detail*/
exports.mastercard = () => {
  return this.cardInfo("mastercard");
};

/* @returns {object} 
- A mastercard visa*/
exports.visa = () => {
  return this.cardInfo("visa");
};

/* @returns {object} 
- A mastercard unionpay*/
exports.unionpay = () => {
  return this.cardInfo("unionpay");
};

/* @returns {object} 
- A mastercard dinners*/
exports.diners = () => {
  return this.cardInfo("diners");
};

/* @returns {object} 
- A mastercard amex*/
exports.amex = () => {
  return this.cardInfo("amex");
};

/* @returns {object} 
- A mastercard discover*/
exports.discover = () => {
  return this.cardInfo("discover");
};

/* @returns {object} 
- A Japan Credit Bureau credit card*/
exports.jcb = () => {
  return this.cardInfo("jcb");
};
