...
exports.findChemicalElementByName = (name = "Hydrogen") => {
...
exports.findChemicalElementByAtomicNumber = (atomic_number = 1) => {
  return fake.periodicTable.find(
...
exports.findChemicalElementBySymbol = (symbol = "Og") => {
  return fake.periodicTable.find(
...
exports.findChemicalElementsByElementGroup = (group = "Nonmetal") => {
